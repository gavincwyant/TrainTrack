      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-0 -left-4 w-72 h-72 bg-blue-500/5 dark:bg-blue-400/10 rounded-full blur-3xl"></div>
            <div className="absolute top-20 -right-4 w-72 h-72 bg-indigo-500/5 dark:bg-indigo-400/10 rounded-full blur-3xl"></div>
          </div>
          ...
          <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 lg:py-40">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <div className="mt-12 flex flex-col sm:flex-row gap-5 justify-center items-center">
                <Link
                  href="/signup"
                  className="group relative w-full sm:w-auto px-10 py-5 text-lg font-semibold text-white bg-gradient-to-r from-blue-600 to-blue-500 dark:from-blue-500 dark:to-blue-600 rounded-2xl hover:from-blue-700 hover:to-blue-600 dark:hover:from-blue-600 dark:hover:to-blue-700 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-600/30 dark:hover:shadow-blue-500/50 hover:-translate-y-1 overflow-hidden"
                >
                ...
                >
                  <span className="flex items-center justify-center w-12 h-12 rounded-full bg-[var(--surface-secondary)] group-hover:bg-blue-500/10 dark:group-hover:bg-blue-400/20 transition-all duration-300 group-hover:scale-110">
                    <svg className="w-5 h-5 text-blue-600 dark:text-blue-400 ml-0.5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <section className="py-24 sm:py-32 bg-[var(--surface)]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-5xl mx-auto grid sm:grid-cols-3 gap-8">
              <div className="group flex flex-col items-center text-center p-8 rounded-3xl bg-[var(--surface-secondary)] border border-[var(--border)] hover:border-blue-500/30 dark:hover:border-blue-400/50 hover:shadow-xl hover:shadow-blue-500/5 dark:hover:shadow-blue-400/10 transition-all duration-300 hover:-translate-y-1">
                <div className="w-20 h-20 rounded-2xl bg-blue-500/10 dark:bg-blue-400/20 flex items-center justify-center mb-6 group-hover:bg-blue-500/15 dark:group-hover:bg-blue-400/30 transition-colors duration-300">
              ...
              <div className="group flex flex-col items-center text-center p-8 rounded-3xl bg-[var(--surface-secondary)] border border-[var(--border)] hover:border-indigo-500/30 dark:hover:border-indigo-400/50 hover:shadow-xl hover:shadow-indigo-500/5 dark:hover:shadow-indigo-400/10 transition-all duration-300 hover:-translate-y-1">
                <div className="w-20 h-20 rounded-2xl bg-indigo-500/10 dark:bg-indigo-400/20 flex items-center justify-center mb-6 group-hover:bg-indigo-500/15 dark:group-hover:bg-indigo-400/30 transition-colors duration-300">
              ...
              <div className="group flex flex-col items-center text-center p-8 rounded-3xl bg-[var(--surface-secondary)] border border-[var(--border)] hover:border-purple-500/30 dark:hover:border-purple-400/50 hover:shadow-xl hover:shadow-purple-500/5 dark:hover:shadow-purple-400/10 transition-all duration-300 hover:-translate-y-1">
                <div className="w-20 h-20 rounded-2xl bg-purple-500/10 dark:bg-purple-400/20 flex items-center justify-center mb-6 group-hover:bg-purple-500/15 dark:group-hover:bg-purple-400/30 transition-colors duration-300">
        ...
        <section className="py-24 sm:py-32 relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-red-500/[0.02] dark:via-red-400/[0.03] to-transparent pointer-events-none"></div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div
                    key={index}
                    className="group flex items-start gap-5 p-6 bg-[var(--surface-secondary)] rounded-2xl border border-[var(--border)] hover:border-red-500/20 dark:hover:border-red-400/30 hover:shadow-lg dark:hover:shadow-2xl dark:hover:shadow-black/20 transition-all duration-300"
                  >
                    <span className="flex-shrink-0 w-10 h-10 rounded-xl bg-red-500/10 dark:bg-red-400/20 flex items-center justify-center group-hover:bg-red-500/15 dark:group-hover:bg-red-400/30 transition-colors">
        ...
        <section className="py-24 sm:py-32 bg-[var(--surface)]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8 lg:gap-10">
              {/* Smart Scheduling */}
              <div className="group relative p-10 bg-[var(--surface)] rounded-3xl border-2 border-[var(--border)] shadow-lg dark:shadow-2xl dark:shadow-black/20 hover:shadow-2xl hover:shadow-blue-500/10 dark:hover:shadow-blue-400/20 hover:border-blue-500/50 dark:hover:border-blue-400/50 transition-all duration-300 hover:-translate-y-2">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500/10 to-blue-600/10 dark:from-blue-400/20 dark:to-blue-500/20 flex items-center justify-center mb-8 group-hover:scale-110 group-hover:from-blue-500/20 group-hover:to-blue-600/20 dark:group-hover:from-blue-400/30 dark:group-hover:to-blue-500/30 transition-all duration-300">
              ...
              <div className="group relative p-10 bg-[var(--surface)] rounded-3xl border-2 border-[var(--border)] shadow-lg dark:shadow-2xl dark:shadow-black/20 hover:shadow-2xl hover:shadow-green-500/10 dark:hover:shadow-green-400/20 hover:border-green-500/50 dark:hover:border-green-400/50 transition-all duration-300 hover:-translate-y-2">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-green-500/10 to-green-600/10 dark:from-green-400/20 dark:to-green-500/20 flex items-center justify-center mb-8 group-hover:scale-110 group-hover:from-green-500/20 group-hover:to-green-600/20 dark:group-hover:from-green-400/30 dark:group-hover:to-green-500/30 transition-all duration-300">
              ...
              {/* Tax-Ready Reports */}
              <div className="group relative p-10 bg-[var(--surface)] rounded-3xl border-2 border-[var(--border)] shadow-lg dark:shadow-2xl dark:shadow-black/20 hover:shadow-2xl hover:shadow-purple-500/10 dark:hover:shadow-purple-400/20 hover:border-purple-500/50 dark:hover:border-purple-400/50 transition-all duration-300 hover:-translate-y-2">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500/10 to-purple-600/10 dark:from-purple-400/20 dark:to-purple-500/20 flex items-center justify-center mb-8 group-hover:scale-110 group-hover:from-purple-500/20 group-hover:to-purple-600/20 dark:group-hover:from-purple-400/30 dark:group-hover:to-purple-500/30 transition-all duration-300">
        ...
        <section className="py-20 sm:py-24 bg-[var(--surface-secondary)]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-[var(--surface)] rounded-2xl border border-[var(--border)] shadow-lg dark:shadow-2xl dark:shadow-black/20 p-8 sm:p-10">
                <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-6 text-center">
                  As an early user, you get:
                </h3>
                <div className="grid sm:grid-cols-3 gap-6">
                  <div className="flex flex-col items-center text-center p-4">
                    <div className="w-12 h-12 rounded-full bg-green-500/10 dark:bg-green-400/20 flex items-center justify-center mb-4">
                  ...
                  <div className="flex flex-col items-center text-center p-4">
                    <div className="w-12 h-12 rounded-full bg-blue-500/10 dark:bg-blue-400/20 flex items-center justify-center mb-4">
                  ...
                  <div className="flex flex-col items-center text-center p-4">
                    <div className="w-12 h-12 rounded-full bg-purple-500/10 dark:bg-purple-400/20 flex items-center justify-center mb-4">
        ...
        {/* Final CTA Section */}
        <section className="relative py-32 sm:py-40 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 dark:from-blue-700 dark:via-blue-800 dark:to-indigo-900 overflow-hidden">
          {/* Decorative elements */}
          ...
          <div className="absolute top-10 left-10 w-64 h-64 bg-white/5 dark:bg-white/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-10 right-10 w-96 h-96 bg-indigo-400/10 dark:bg-indigo-300/15 rounded-full blur-3xl"></div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <Link
                href="/signup"
                className="group inline-block px-12 py-6 text-xl font-semibold text-blue-600 dark:text-blue-700 bg-white dark:bg-gray-50 rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-100 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 hover:scale-105"
              >
