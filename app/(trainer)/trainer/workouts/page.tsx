    ...
    <div className="max-w-6xl mx-auto space-y-8">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="mt-2 text-gray-600">View and manage all logged workout sessions</p>
        </div>
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        {isLoading ? (
          <p className="text-gray-600">Loading workout sessions...</p>
        ) : sessions.length === 0 ? (
                  ...
                  <div className="mb-4">
                    ...
                    <div className="space-y-2">
                      {session.exercises.map((exercise, idx) => (
                        <div
                          key={idx}
                          className="flex justify-between items-start p-3 bg-white border border-gray-200 rounded-md"
                        >
